...
(
  ...
  Machine_Date_Creation datetime     NOT NULL,
...
(
  ...
  Disque_Date_Creation       datetime     NOT NULL,
...
(
  ...
  Os_Date_Creation            datetime     NOT NULL,
...
CREATE TABLE Historique_Client_Machine
(
  id_historique_client_machine int          NOT NULL IDENTITY(1,1),
  id_client_machine            int          NOT NULL,
  id_client                    int          NOT NULL,
  Nom_Machine                  varchar(255) NOT NULL,
  Machine_Date_Creation        datetime     NOT NULL,
  CONSTRAINT PK_Historique_Client_Machine PRIMARY KEY (id_historique_client_machine)
)

ALTER TABLE Historique_Client_Machine
  ADD CONSTRAINT UQ_id_historique_client_machine UNIQUE (id_historique_client_machine)

CREATE TABLE Historique_Client_Machine_Disque
(
  id_historique_client_machine_disque int          NOT NULL IDENTITY(1,1),
  id_historique_client_machine        int          NOT NULL,
  Nom_Disque                          varchar(255) NOT NULL,
  Dossier_Racine                      varchar(255) NOT NULL,
  Label                               varchar(255),
  Type                                varchar(255) NOT NULL,
  ...
  Is_System_Drive                     bit          NOT NULL,
  Disque_Date_Creation                datetime     NOT NULL,
  CONSTRAINT PK_Historique_Client_Machine_Disque PRIMARY KEY (id_historique_client_machine_disque)
)

ALTER TABLE Historique_Client_Machine_Disque
  ADD CONSTRAINT UQ_id_historique_client_machine_disque UNIQUE (id_historique_client_machine_disque)

CREATE TABLE Historique_Client_Machine_Disque_Os
(
  id_historique_client_machine_disque_os int          NOT NULL IDENTITY(1,1),
  id_historique_client_machine_disque    int          NOT NULL,
  Dossier                                varchar(255) NOT NULL,
  Architecture                           varchar(255) NOT NULL,
  Version                                varchar(255) NOT NULL,
  Nom_Produit                            varchar(255),
  ...
  Update_Build_Revision                  varchar(255),
  Os_Date_Creation                       datetime     NOT NULL,
  CONSTRAINT PK_Historique_Client_Machine_Disque_Os PRIMARY KEY (id_historique_client_machine_disque_os)
)

ALTER TABLE Historique_Client_Machine_Disque_Os
  ADD CONSTRAINT UQ_id_historique_client_machine_disque_os UNIQUE (id_historique_client_machine_disque_os)

CREATE TABLE Historique_Relation_Disque_Application
(
  id_historique_client_machine_disque int           NOT NULL,
  ...
  Application_Date_Creation           datetime      NOT NULL,
  CONSTRAINT PK_Historique_Relation_Disque_Application PRIMARY KEY (id_historique_client_machine_disque, id_client_machine_disque_app)
)
...
ALTER TABLE Historique_Client_Machine_Disque
  ADD CONSTRAINT FK_Historique_Client_Machine_TO_Historique_Client_Machine_Disque
    FOREIGN KEY (id_historique_client_machine)
    REFERENCES Historique_Client_Machine (id_historique_client_machine)

ALTER TABLE Historique_Client_Machine_Disque_Os
  ADD CONSTRAINT FK_Historique_Client_Machine_Disque_TO_Historique_Client_Machine_Disque_Os
    FOREIGN KEY (id_historique_client_machine_disque)
    REFERENCES Historique_Client_Machine_Disque (id_historique_client_machine_disque)

ALTER TABLE Historique_Relation_Disque_Application
  ADD CONSTRAINT FK_Historique_Client_Machine_Disque_TO_Historique_Relation_Disque_Application
    FOREIGN KEY (id_historique_client_machine_disque)
    REFERENCES Historique_Client_Machine_Disque (id_historique_client_machine_disque)

ALTER TABLE Historique_Relation_Disque_Application
  ADD CONSTRAINT FK_Client_Machine_Disque_Application_TO_Historique_Relation_Disque_Application
    FOREIGN KEY (id_client_machine_disque_app)
    REFERENCES Client_Machine_Disque_Application (id_client_machine_disque_app)

ALTER TABLE Historique_Client_Machine
  ADD CONSTRAINT FK_Client_Machine_TO_Historique_Client_Machine
    FOREIGN KEY (id_client_machine)
    REFERENCES Client_Machine (id_client_machine)
